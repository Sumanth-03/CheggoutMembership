...
const subscriptionsItems = [Aha, Hotstar, OttPlay, Prime];
const offersItems = [LifeStyle, Decathlon, Levis, AX];

const DiscountItems = [Puma, Myntra, Ajio, Swiggy];
const CheggoutItems = [img1, img2, img3, img4];
  ...
  return (
    <div className="flex flex-col p-2">
      ...
      <div className="flex flex-row gap-2 overflow-auto justify-center">
        ...
        <div
          className="flex items-center justify-center p-2 text-center font-medium"
          style={{ color: "#8A9AB0" }}
        >
          & <br />
          more
...
function Offers() {
  return (
    <div className="h-[60%] portrait:overflow-auto pb-24">
      <Scrollbar
        headding="Free Premium Subscriptions"
        items={subscriptionsItems}
      ></Scrollbar>
      <Scrollbar
        headding="Offers on Brand Gift Cards"
        items={offersItems}
      ></Scrollbar>
      <Scrollbar
        headding="Deals & Discount Coupons for Top Brands"
        items={DiscountItems}
      ></Scrollbar>
      <Scrollbar
        headding="Assured Benefits on Cheggout"
        items={CheggoutItems}
      ></Scrollbar>
    </div>
  );
