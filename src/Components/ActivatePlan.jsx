  ...
  return (
    <div className="bg-primary p-2 w-full sm:w-[480px] m-auto h-full sm:shadow-lg sm:rounded-2xl">
      ...
      <p className="text-gray-600 p-2">
        Enter the promocode received through our partner to view plan detais
      </p>
      <section
        className="m-2 p-2 rounded-2xl flex flex-row items-center"
        style={{ backgroundColor: "#384E6D" }}
      >
        <input
          placeholder="Enter Promocode"
          className="text-white bg-transparent py-4 text-xl focus:border-none focus:outline-none"
        ></input>
        <Link
          to="/verify-promo"
          className="ml-auto text-lg font-medium p-4"
          style={{ color: "#FF5838" }}
        >
          Apply
        </Link>
